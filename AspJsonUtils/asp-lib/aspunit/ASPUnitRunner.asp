...
Class UnitRunner
	private m_pathToThis
	Private m_dicTestContainer

	Private m_STYLESHEET
	Private m_SCRIPTFILE
	
	public property let pathToThis(pathToThis_)
		m_pathToThis = pathToThis_
	end property
	
	public property get pathToThis
		pathToThis = m_pathToThis
	end property
	
	public property get STYLESHEET
		STYLESHEET = m_pathToThis & "ASPUnit.css"
	end property
	
	public property get SCRIPTFILE
		STYLESHEET = m_pathToThis & "ASPUnitRunner.js"
	end property
	
	Private Sub Class_Initialize()
		Set m_dicTestContainer = CreateObject("Scripting.Dictionary")
		m_pathToThis = "/includes/aspunit/"
	End Sub
